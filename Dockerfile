...
#
# build:
#   docker build --force-rm -t kosten854/koa-skeleton --build-arg NPM_TOKEN=${NPM_TOKEN} .
# run:
#   docker run --rm -it --env-file=path/to/.env --name koa-skeleton -p 80:7071 kosten854/koa-skeleton
#
#
